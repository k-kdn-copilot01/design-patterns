 ...
 * Uses thread-safe lazy initialization with mutex locking.
 */
class DatabaseConnection
{
    ...
    // Thread-safe lazy initialization using lock mechanism
    public static function getInstance()
    {
        if (self::$instance === null) {
            // Simple lock mechanism for thread safety simulation
            if (!self::$lock) {
                self::$lock = true;
                if (self::$instance === null) {
